...
**Not on crates.io.** `cargo add ag-ui-server` installs a different, unrelated project.
...
- rustdoc for all five crates:
  <https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui_server/index.html>
