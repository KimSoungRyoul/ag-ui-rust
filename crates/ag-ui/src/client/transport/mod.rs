...
//!
//! [`Transport`] is deliberately small: hand it a [`RunAgentInput`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/input/struct.RunAgentInput.html), get back a
//! stream of [`Event`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/event/enum.Event.html)s. Implementations shipped here:
//!
