...
//! [`RunAgentInput`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/input/struct.RunAgentInput.html)s it was handed, which is how a test asserts that a resume
