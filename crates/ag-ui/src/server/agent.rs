...
///
/// [`crate::client::RemoteAgent`]: https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/client/agent/struct.RemoteAgent.html
///
/// ```
...
pub trait Agent: Send + Sync {
    ...
    /// [`RunAgentInput::state`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/input/struct.RunAgentInput.html#structfield.state) and published
