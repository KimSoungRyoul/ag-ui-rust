...
//!
//! [`ag-ui-server`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/index.html) turns an [`Agent`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/agent/trait.Agent.html) into a
...
//! [`Err`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/error/enum.Error.html#method.agent) instead; reach for
...
//! [`CancellationToken`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/cancel/struct.CancellationToken.html) on drop, and disarms
//! itself if the run got to finish. An agent sees it through
//! [`RunContext::is_cancelled`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/context/struct.RunContext.html#method.is_cancelled),
//! [`until_cancelled`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/context/struct.RunContext.html#method.until_cancelled), or simply by
...
//! Applying a [`StreamTransformer`](https://kimsoungryoul.github.io/ag-ui-rust/api/ag_ui/serve/transform/trait.StreamTransformer.html) there
