...
`ag-ui-a2ui` remains a separate A2UI protocol and authoring crate. Its schemas and
...
This repository is an independent SDK. The proposal to use it under
[`sdks/community/rust`](https://github.com/ag-ui-protocol/ag-ui/issues/2256#issuecomment-5689944347)
requires an upstream team decision on scope, ownership and publishing. A discussion
or successful conformance check is not that approval. A contribution should retain
the drift and semantic checks and state which SDK crates are included.
